...
api_base = os.getenv("OPENAI_API_KEY")
api_key = os.getenv("OPENAI_API_KEY")
api_type = os.environ.get("AZURE_OPENAI_TYPE", "none")
api_version = os.environ.get("AZURE_OPENAI_VERSION", "2023-12-01-preview")
chat_completion_deployment = "gpt-3.5-turbo-0125"  # ,os.getenv("AZURE_OPENAI_DEPLOYMENT")
embeddings_deployment = "text-embedding-3-large"  # ,os.getenv("AZURE_OPENAI_ADA_DEPLOYMENT")
